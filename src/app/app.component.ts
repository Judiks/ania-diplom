...
export class AppComponent implements AfterViewInit {
  ...
  files = [{
    name: 'KHAI.glb',
    title: '',
    subTitle: '3D-модель студмістечка Харківського Національного аерокосмічного університету ім. М.Є. Жуковського "ХАІ"'
  }, {
    name: 'ULK_KHAI.glb',
    title: '',
    subTitle: '3D-модель навчально-лабораторного корпуску Харківського Національного аерокосмічного університету ім. М.Є. Жуковського "ХАІ"'
  }]
  currentIndex = 0;
  totalLoaded = 0;
  loadedFiles: number[] = []
